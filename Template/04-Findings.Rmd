...
vartable2 <- vartable2 %>% mutate(uc.LRstat = paste0(uc.LRstat,signif()))
VarACDtable <- matrix(nrow = )
...
ESTestingACD(rollacd, var = as.vector(rollacd@forecast$VaR$`alpha(1%)`), "sstd")
ESTesting(rollg, var = rollg@forecast$VaR$`alpha(1%)`, "sstd")
```
