...
plot(density(rugarch::residuals(garchfit.eGARCH[[3]], standardize = T)), lwd = 2, main = "AV GARCH Residuals")
curve(dnorm(x, , mean=mean(rugarch::residuals(garchfit.eGARCH[[3]], standardize = T)), sd=sd(rugarch::residuals(garchfit.eGARCH[[3]], standardize = T))), 
