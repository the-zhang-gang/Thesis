...
GMMTest.2 = function(z, lags = 22, skew=0, kurt=3, conf.level = 0.95){
  require(rugarch)
...
GMMTest.2(rugarch::residuals(garchfit.eGARCH[[1]],standardize=TRUE))
