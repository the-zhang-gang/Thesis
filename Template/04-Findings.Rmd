...
Table2_SE[4,c("alpha","beta","kappa","xi")] <- paste0("(",round(SGED_result$sd, 3),")",SGED_significance)
# "alpha","beta","xi","kappa","eta","L","AIC"
Table2_SE[6,c("alpha","beta","kappa")] <- paste0("(",round(GED_result$sd, 3),")",GED_significance)
# "alpha","beta","xi","kappa","eta","L","AIC"
Table2_SE[8,c("alpha","beta","xi","eta")] <- paste0("(",round(ST_result$sd,3),")",ST_significance)
# "alpha","beta","xi","kappa","eta","L","AIC"
