...
\noindent Additionally, for every distribution fitted with MLE, plots are generated to compare the theoretical distribution with the observed returns and reported in the appendix. We see that the normal distribution is not a good approximation. The other theoretical distributions are closer to the actual data, except that they are somewhat too peaked. This phenomenon is the least present for the SGT distribution. 
...
lines(xvals, dsgt(xvals, mu = 0.012, sigma = 1.635, lambda = -0.043, p =2 , q = 2.817/2), col = "red")
legend("topleft",legend = c("Actual distribution","Theoretical distribution"), col = c("black","red"), pch=1)
