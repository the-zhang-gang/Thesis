...
```{r figVaRinsample, fig.cap="Value-at-Risk (in-sample) for the EGARCH-ST model", fig.align='center', out.width='90%', echo=FALSE}
par(mfrow = c(2,1))
...
plot(absolutereturns, main = 'Conditional Sigma',col = c('grey'),xlab = "Time", ylab = "");lines(condvar,col= 'steelblue'); legend(x="topleft", legend = c("absolute log-returns", "conditional volatility"), col = c('grey', 'steelblue'),lty = c(1,1), bty = 'n', cex = 0.8)
