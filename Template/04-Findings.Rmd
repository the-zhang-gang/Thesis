...
df <- as.matrix(df)
rownames(df) <- c("AE_var","AE_ES", "UC","CC","DQ","AE var","AE ES","UC","CC","DQ","AE var","AE ES","UC","CC","DQ","AE var","AE ES","UC","CC","DQ","AE var","AE ES","UC","CC","DQ")
```
...
Lj.box.test.function <- function(garchmodel = garchfit.sGARCH, n.list = 1, days.lag = 22){
  tmp.1 <- Box.test(rugarch::residuals(garchmodel[[n.list]], standardize = T),days.lag, "Ljung-Box") 
