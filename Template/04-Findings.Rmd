...
kbl(object.df, col.names = toupper(colnames(object.df)),caption = "Maximum likelihood estimates of the ST-ACD models with constant skewness and kurtosis parameters",#format = "latex",
      label = 'Table5',
      booktabs = T, row.names = T, escape = F )%>%
  kable_classic(full_width = F)%>%
  footnote(general = c(fn1.3b,fn2.3),threeparttable = T,footnote_as_chunk = F, escape=F, general_title = "Notes:")%>%
  kable_styling(latex_options = "scale_down")
```
