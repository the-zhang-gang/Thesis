...
Eurostoxx %>% kbl(caption = "Maximum likelihood estimates of unconditional distribution functions", "latex", #add a hash before "latex"
      label = 'MLEtable',
      booktabs = T,
      position = "h!",
      digits = 3,
  ...
  footnote(general = sprintf("This table shows the parameter estimatesof the different unconditional distribution of the Skewed Generalized t (SGT), Skewed Generalized Error Distribution (SGED), Generalized Error Distribution (GED), Skewed t (ST), Symmetric t (T) and Normal distribution. The results are based on the daily ra reeturns on the EURO STOXX 50 spanning the period from %s to %s (%s observations). Standard errors are given below the parameter estimates, *, **, *** represent significance levels at the 10, 5 and 1 percent.",format(index(head(R,1)), '%d %B, %Y'), format(index(tail(R,1)),'%d %B, %Y'), nrow(R)),threeparttable = T,footnote_as_chunk = T, escape=F, general_title = "Note:")
