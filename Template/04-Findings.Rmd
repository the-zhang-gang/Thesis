...
length(VaRsstdegarch)
VaRnormegarch <- as.data.frame(egarch.normback,which="VaR")$`alpha(1%)`
length(R[2501:nrow(R)])
BacktestVaR(R[2501:nrow(R)],VaRsstdegarch,0.01, 5)$LRuc
BacktestVaR(R[2501:nrow(R)],VaRsstdegarch,0.01, 5)$LRcc
BacktestVaR(R[2501:nrow(R)],VaRsstdegarch,0.01, 5)$AE
BacktestVaR(R[2501:nrow(R)],VaRsstdegarch,0.01, 5)$DQ
