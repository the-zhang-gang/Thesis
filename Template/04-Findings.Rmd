...
Return <- read_excel("data/Price_Return.xlsx", 
    sheet = "Return", col_types = c("date", 
        rep("numeric", 4)))

Return <- xts(Return[,-1], order.by = Return$Name)
Return <- window(Return, start = "2001-01-02")
Return <- diff(Return, log = TRUE, na.pad = FALSE)*100
R <- Return$ES50
require(readr)
```
