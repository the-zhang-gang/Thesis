...
egarch.normback <- roll(garchspec.eGARCH[[1]])
egarch.stdback <- roll(garchspec.eGARCH[[2]])
egarch.sstdback <- roll(garchspec.eGARCH[[3]])
egarch.gedback <- roll(garchspec.eGARCH[[4]])
egarch.sgedback <- roll(garchspec.eGARCH[[5]])

gjrgarch.normback <- roll(garchspec.gjrGARCH[[1]])
gjrgarch.stdback <- roll(garchspec.gjrGARCH[[2]])
gjrgarch.sstdback <- roll(garchspec.gjrGARCH[[3]])
gjrgarch.gedback <- roll(garchspec.gjrGARCH[[4]])
gjrgarch.sgedback <- roll(garchspec.gjrGARCH[[5]])

nagarch.normback <- roll(garchspec.fGARCH.NAGARCH[[1]])
nagarch.stdback <- roll(garchspec.fGARCH.NAGARCH[[2]])
nagarch.sstdback <- roll(garchspec.fGARCH.NAGARCH[[3]])
nagarch.gedback <- roll(garchspec.fGARCH.NAGARCH[[4]])
nagarch.sgedback <- roll(garchspec.fGARCH.NAGARCH[[5]])

tgarch.normback <- roll(garchspec.fGARCH.TGARCH[[1]])
tgarch.stdback <- roll(garchspec.fGARCH.TGARCH[[2]])
tgarch.sstdback <- roll(garchspec.fGARCH.TGARCH[[3]])
tgarch.gedback <- roll(garchspec.fGARCH.TGARCH[[4]])
tgarch.sgedback <- roll(garchspec.fGARCH.TGARCH[[5]])

avgarch.normback <- roll(garchspec.fGARCH.AVGARCH[[1]])
avgarch.stdback <- roll(garchspec.fGARCH.AVGARCH[[2]])
avgarch.sstdback <- roll(garchspec.fGARCH.AVGARCH[[3]])
avgarch.gedback <- roll(garchspec.fGARCH.AVGARCH[[4]])
avgarch.sgedback <- roll(garchspec.fGARCH.AVGARCH[[5]])
```
...
require(GAS)
VaRsstdegarch <- as.data.frame(egarch.sstdback,which="VaR")$`alpha(1%)`
VaRnormegarch <- as.data.frame(egarch.normback,which="VaR")$`alpha(1%)`
BacktestVaR(R,VaRsstdegarch,0.01, 5)
BacktestVaR(R, VaRnormegarch,0.01, 5)
