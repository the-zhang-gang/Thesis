...
DistMLE <- function(series) {
  ...
  plot(xvals, dsstd(xvals, mean = ST_mean, sd = ST_sd, nu = ST_nu, xi=ST_xi), col="red", type ="l", main = "ST")
  lines(density(coredata(series)))
...
Table2_SE[2,2:6] <- paste0("(",round(SGT_result$std.error, 3),")")
Table2_SE[4,2:6] <- paste0("(",round(SGED_result$std.error, 3),")")
Table2_SE[6,2:6] <- paste0("(",round(GED_result$std.error, 3),")")
Table2_SE[8,2:4] <- paste0("(",round(ST_result$sd[-3],3),")")
Table2_SE[8,7] <- paste0("(",round(ST_result$sd[3],3),")")
Table2_SE[10,2:3] <- paste0("(",round(T_result$sd[-3],3),")")
Table2_SE[10,7] <- paste0("(",round(T_result$sd[3],3),")")
Table2_SE[12,2:3] <- paste0("(",round(Normal_result$std.error, 3),")")
...
Eurostoxx %>% kbl(caption = "Maximum likelihood estimates of unconditional distribution functions","latex",
      label = 'dsTable',
      booktabs = T,
      position = "h!",
      digits = 3,
