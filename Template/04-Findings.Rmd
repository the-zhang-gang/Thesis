...
rollacd = racd::acdroll(sGARCH_ACDspec, data = R, n.ahead = 1, refit.every = 50, refit.window = "moving", window.size = 1500, forecast.length = 1500, solver = "msoptim", calculate.VaR = TRUE, VaR.alpha = c(0.01,0.05), keep.coef = TRUE,  solver.control =list(restarts = 10), cluster = cl)
```
