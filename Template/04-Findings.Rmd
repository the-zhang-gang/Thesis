...
Table2_SE[4,c("alpha","beta","kappa","xi")] <- paste0("(",round(c(SGED_result$sd[1:2],SGED_result$sd[4], SGED_result$sd[3], NA),3),")", SGED_significance)
# "alpha","beta","xi","kappa","eta","L","AIC"
Table2_SE[6,c("alpha","beta","kappa")] <- paste0("(",round(c(GED_result$sd[1:2],NA,GED_result$sd[3],NA), 3),")",GED_significance)
# "alpha","beta","xi","kappa","eta","L","AIC"
Table2_SE[8,c("alpha","beta","xi","eta")] <- paste0("(",round(c(ST_result$sd[1:2],ST_result$sd[4],NA,ST_result$sd[3]),3),")",ST_significance)
# "alpha","beta","xi","kappa","eta","L","AIC"
...
table2[table2 == "(NA)"] <- NA
colnames(table2) <- c("", "$\\mu$","$\\sigma$","$\\xi$","$\\kappa$","$\\eta$","$L$","AIC")  
```

```{r results='asis'}
kbl(table2,caption = "Maximum likelihood estimates of unconditional distribution functions",
      label = 'MLEtable',
      booktabs = T,
      position = "h!",
      digits = 3,
