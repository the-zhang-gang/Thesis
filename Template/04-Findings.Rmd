...
#WEIGHTED LJUNG-BOX TEST ON STANDARDIZED ABSOLUTE RESIDUALS
...
GMM.test.function <- function(garchmodel=garchfit.eGARCH,n.list = 1){
  ...
  test <- c(tmp.1$moment.mat[3,1],tmp.1$moment.mat[3,2],tmp.1$moment.mat[3,3], tmp.1$moment.mat[3,4]) # t values is row 1
  return(test)
}
...
jarqueberaTest(rugarch::residuals(garchmodel[[n.list]], standardize = T)) 
