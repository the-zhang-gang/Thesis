...
Table.tests.function <- function(imput.function = Lj.box.test.function){
...
for(i in 1:length(distributions)){
  LJ.Test[[1]][,i] <- imput.function(garchmodel = garchfit.sGARCH, n.list = i)
    LJ.Test[[2]][,i] <- imput.function(garchmodel = garchfit.eGARCH, n.list = i)
      LJ.Test[[3]][,i] <- imput.function(garchmodel = garchfit.fGARCH.AVGARCH, n.list = i)
        LJ.Test[[4]][,i] <- imput.function(garchmodel = garchfit.fGARCH.NAGARCH, n.list = i)
          LJ.Test[[5]][,i] <- imput.function(garchmodel = garchfit.gjrGARCH, n.list = i)
            LJ.Test[[6]][,i] <- imput.function(garchmodel = garchfit.fGARCH.TGARCH, n.list = i)
              LJ.Test[[7]][,i] <- imput.function(garchmodel = garchfit.iGARCH, n.list = i)
                LJ.Test[[8]][,i] <- imput.function(garchmodel = garchfit.EWMA, n.list = i)
}
...
LJ.test.df <- Table.tests.function(imput.function = Lj.box.test.function)
```
...
LJ.test.df.2 <- Table.tests.function(imput.function = Lj.box.test.function.2)
...
ARCH.lm.Test.df <- Table.tests.function(imput.function = archlmtest)
...
JB.test.df <- suppressWarnings(Table.tests.function(imput.function = Jarque.bera.test.function))
