...
#PVALUES LOOPS
r3 <- 
r4 <- c(uc.signific(egarch.sgedback),uc.signific(gjrgarch.sgedback),uc.signific(tgarch.sgedback),uc.signific(nagarch.sgedback),uc.signific(avgarch.sgedback))
r5 <- c(cc.signific(egarch.sgedback),cc.signific(gjrgarch.sgedback),cc.signific(tgarch.sgedback),cc.signific(nagarch.sgedback),cc.signific(avgarch.sgedback))
r6 <- c(dq.signific(egarch.sgedback),dq.signific(gjrgarch.sgedback),dq.signific(tgarch.sgedback),dq.signific(nagarch.sgedback),dq.signific(avgarch.sgedback))

r9 <- 
r10 <- c(uc.signific(egarch.gedback),uc.signific(gjrgarch.gedback),uc.signific(tgarch.gedback),uc.signific(nagarch.gedback),uc.signific(avgarch.gedback))
r11 <- c(cc.signific(egarch.gedback),cc.signific(gjrgarch.gedback),cc.signific(tgarch.gedback),cc.signific(nagarch.gedback),cc.signific(avgarch.gedback))
r12 <- c(dq.signific(egarch.gedback),dq.signific(gjrgarch.gedback),dq.signific(tgarch.gedback),dq.signific(nagarch.gedback),dq.signific(avgarch.gedback))

r15 <- 
r16 <- c(uc.signific(egarch.sstdback),uc.signific(gjrgarch.sstdback),uc.signific(tgarch.sstdback),uc.signific(nagarch.sstdback),uc.signific(avgarch.sstdback))
r17 <- c(cc.signific(egarch.sstdback),cc.signific(gjrgarch.sstdback),cc.signific(tgarch.sstdback),cc.signific(nagarch.sstdback),cc.signific(avgarch.sstdback))
r18 <- c(dq.signific(egarch.sstdback),dq.signific(gjrgarch.sstdback),dq.signific(tgarch.sstdback),dq.signific(nagarch.sstdback),dq.signific(avgarch.sstdback))

r21 <- 
r22 <- c(uc.signific(egarch.stdback),uc.signific(gjrgarch.stdback),uc.signific(tgarch.stdback),uc.signific(nagarch.stdback),uc.signific(avgarch.stdback))
r23 <- c(cc.signific(egarch.stdback),cc.signific(gjrgarch.stdback),cc.signific(tgarch.stdback),cc.signific(nagarch.stdback),cc.signific(avgarch.stdback))
r24 <- c(dq.signific(egarch.stdback),dq.signific(gjrgarch.stdback),dq.signific(tgarch.stdback),dq.signific(nagarch.stdback),dq.signific(avgarch.stdback))

r27 <- 
r28 <- c(uc.signific(egarch.normback),uc.signific(gjrgarch.normback),uc.signific(tgarch.normback),uc.signific(nagarch.normback),uc.signific(avgarch.normback))
r29 <- c(cc.signific(egarch.normback),cc.signific(gjrgarch.normback),cc.signific(tgarch.normback),cc.signific(nagarch.normback),cc.signific(avgarch.normback))
r30 <- c(dq.signific(egarch.normback),dq.signific(gjrgarch.normback),dq.signific(tgarch.normback),dq.signific(nagarch.normback),dq.signific(avgarch.normback))
