...
Maximum likelihood estimation is a method to find the distribution parameters that best fit the observed data, through maximization of the likelihood function. This function is based on the joint probability distribution of the observed data, and allows the parameters to vary.
