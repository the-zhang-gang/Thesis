...
We worked with daily returns on the EURO STOXX 50 Index denoted in EUR, from `r format(index(head(Estoxx,1)), '%d %B, %Y')` to `r format(index(tail(Estoxx,1)),'%d %B, %Y')`. It is the leading blue-chip index of the Eurozone, was founded in 1998 and covers 50 of the most liquid and largest stocks in terms of free-float market capitalization. Its composition is reviewed annually in September and from each of the 19 EURO STOXX Supersector indices the biggest stocks are selected until the coverage is at 60% of the free-float market cap of each of the EURO STOXX Supersector index then all the current EURO STOXX 50 stocks are used in the selection list from which the largest 40 in terms of free-float market cap are selected and the remaining 10 stocks are chosen amongst those ranked between 41 and 60 [@EUROSTOXXFactSheet].
