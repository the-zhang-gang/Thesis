...
```{=tex}
\begin{align}
\text { Index }_{t}=\frac{\sum_{i=1}^{n}\left(p_{i t} \times s_{i t} \times f f_{i t} \times c f_{i t} \times x_{i t}\right)}{D_{t}}=\frac{M_{t}}{D_{t}}
(\#eq:Laspeyresformula)
\end{align}
```
...
```{=tex}
\begin{align}
D_{t+1}=D_{t} \times \frac{\sum_{i=1}^{n}\left(p_{i t} \times s_{i t} \times f f_{i t} \times c f_{i t} \times x_{i t}\right) \pm \Delta M C_{t+1}}{\sum_{i=1}^{n}\left(p_{i t} \times s_{i t} \times f f_{i t} \times c f_{i t} \times x_{i t}\right)}
(\#eq:Priceweighted)
\end{align}
```
