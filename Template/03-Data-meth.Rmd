...
\noindent Changes in weights caused by corporate actions are proportionally distributed across the components of the index and the index Divisor is computed with the \@ref(eq:Price.weighted)
...
\@ref:stats provides the main statistics describing the return series analyzed. The Arithmetic Mean of the series is `r table1[1,2]` with a standard deviation of `r table1[5,2]`
...
fn2 <- 'Note 2: The standardized residual is derived from a maximum likelyhood estimation as follows: \n' 
