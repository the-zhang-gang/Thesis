...
table1 %>% kbl(caption = "Summary statistics of the returns",
  ...
  footnote(general = c("Notes:",fn1,fn2,fn3,fn4,fn4b,fn5), general_title = "" , threeparttable = T)  
