...
#change eurostoxx
fn1 <- sprintf('Note 1: This table shows the descriptive statistics of the daily percentage returns of %s over the period %s to %s (%s observations). Including arithmetic mean, median, maximum, minimum, standard deviation, skewness, excess kurtosis and the Jarque-Bera test.',"EuroStoxx 50",gsub(" UTC", "",min(index(R))),gsub(" UTC", "",max(index(R))),nrow(R))
