...
```{=tex}
\begin{align} 
\mathbb{E}_T(\varepsilon_{T+k}^2) &= \omega*(1+\alpha_1 + ... + \alpha^{k-2}) + \alpha^{k-1}*\sigma_{T+1}^2
\mathbb{E}_T(\varepsilon_{T+k}^2) &= \omega*(1+\alpha_1 + ... + \alpha^{k-1}) + \alpha^{k}*\sigma_{T}^2
 (\#eq:eq11)
\end{align}
```
