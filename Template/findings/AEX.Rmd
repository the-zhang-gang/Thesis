...
require(dplyr)
# VaRTest----
vartable = rbind(as.data.frame(VaRTest(alpha = 0.01,actual =rollacd@forecast$VaR[,'realized'],VaR=rollacd@forecast$VaR[,'alpha(1%)']),row.names =c('ACD(1%)')),
...
# DQ Test
DQ_ACD <- GAS::BacktestVaR(R[(nstart+1):nrow(R)],rollacd@forecast$VaR$`alpha(1%)`,0.01, 5)$DQ
