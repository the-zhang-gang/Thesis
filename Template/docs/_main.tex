...
\title{Thesis title}
\author{Faes,Mertens de Wilmars,Pratesi}
...
%
\def\crest{{\includegraphics{templates/AMSLOGO.jpg}}}
...
\begin{acknowledgements}
  ...
  Special thanks to \href{http://chester.rbind.io}{Chester Ismay}, who created the ``thesisdown'' package that helped many a PhD student write their theses in R Markdown. And a very special thanks to John McManigle, whose adaption of Sam Evans' adaptation of Keith Gillow's original maths template for writing an Oxford University DPhil thesis in LaTeX provided the template that Ulrik Lyngs in turn adapted for R Markdown.
