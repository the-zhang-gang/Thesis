...
\noindent We worked with daily returns on the Euro Stoxx 50 Price Index\footnote{The same analysis has been performed for the INDEX 1, INDEX 2, INDEX 3 and the INDEX 4 indexes with the same conclusions. The findings of these researches are available upon requests.} denoted in EUR from 31 December, 1986 to 27 April, 2021. It is the leading blue-chip index of the Eurozone, was founded in 1999 and covers 50 of the most liquid and largest (in terms of free-float market capitalization) stocks. For its composition we refer to the factsheet \autocite{EUROSTOXXFactSheet}.
...
\NormalTok{Table.GARCH.function }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(}\AttributeTok{GARCHfit.object =}\NormalTok{ garchfit.eGARCH)\{}
\CommentTok{\#Making objects to fill  }
\NormalTok{list.table.}\FloatTok{3.}\NormalTok{tmp }\OtherTok{\textless{}{-}} \FunctionTok{vector}\NormalTok{(}\AttributeTok{mode =} \StringTok{"list"}\NormalTok{, }\AttributeTok{length =} \FunctionTok{length}\NormalTok{(distributions)}\SpecialCharTok{*}\DecValTok{2}\NormalTok{)}
\NormalTok{list.table}\FloatTok{.3} \OtherTok{\textless{}{-}} \FunctionTok{vector}\NormalTok{(}\AttributeTok{mode =} \StringTok{"list"}\NormalTok{, }\AttributeTok{length =} \FunctionTok{length}\NormalTok{(distributions))}
\FunctionTok{names}\NormalTok{(list.table}\FloatTok{.3}\NormalTok{) }\OtherTok{\textless{}{-}}\NormalTok{ distributions}
\NormalTok{ref.distr }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\AttributeTok{from =} \DecValTok{1}\NormalTok{, }\AttributeTok{to =} \FunctionTok{length}\NormalTok{(distributions)}\SpecialCharTok{*}\DecValTok{2}\NormalTok{, }\AttributeTok{by =} \DecValTok{2}\NormalTok{)}
\CommentTok{\#Retriving all the data from the original lists}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(distributions))\{}
\NormalTok{    list.table.}\FloatTok{3.}\NormalTok{tmp[[ref.distr[i]]] }\OtherTok{\textless{}{-}}\NormalTok{ GARCHfit.object[[i]]}\SpecialCharTok{@}\NormalTok{fit}\SpecialCharTok{$}\NormalTok{coef}
\NormalTok{    list.table.}\FloatTok{3.}\NormalTok{tmp[[ref.distr[i]}\SpecialCharTok{+}\DecValTok{1}\NormalTok{]] }\OtherTok{\textless{}{-}}\NormalTok{ GARCHfit.object[[i]]}\SpecialCharTok{@}\NormalTok{fit}\SpecialCharTok{$}\NormalTok{tval}
\NormalTok{\}}
\CommentTok{\#From list of vectors of different lengths to list of matrixes with empty spaces filled with NAs}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(distributions))\{}
\NormalTok{  list.table}\FloatTok{.3}\NormalTok{[[i]] }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(list.table.}\FloatTok{3.}\NormalTok{tmp[[ref.distr[i]]], list.table.}\FloatTok{3.}\NormalTok{tmp[[ref.distr[i]}\SpecialCharTok{+}\DecValTok{1}\NormalTok{]][}\FunctionTok{match}\NormalTok{(}\FunctionTok{names}\NormalTok{(list.table.}\FloatTok{3.}\NormalTok{tmp[[ref.distr[i]]]), }\FunctionTok{names}\NormalTok{(list.table.}\FloatTok{3.}\NormalTok{tmp[[ref.distr[i]}\SpecialCharTok{+}\DecValTok{1}\NormalTok{]]))])}
\NormalTok{\}}
...
\NormalTok{table.}\FloatTok{3.}\NormalTok{matrix[}\FunctionTok{c}\NormalTok{(}\FunctionTok{length}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix[,}\DecValTok{2}\NormalTok{])}\SpecialCharTok{{-}}\DecValTok{3}\NormalTok{,}\FunctionTok{length}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix[,}\DecValTok{2}\NormalTok{])}\SpecialCharTok{{-}}\DecValTok{2}\NormalTok{),}\DecValTok{2}\NormalTok{] }\OtherTok{\textless{}{-}} \StringTok{""}
\NormalTok{table.}\FloatTok{3.}\NormalTok{matrix[}\FunctionTok{c}\NormalTok{(}\FunctionTok{length}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix[,}\DecValTok{4}\NormalTok{])}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{,}\FunctionTok{length}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix[,}\DecValTok{4}\NormalTok{])),}\DecValTok{4}\NormalTok{] }\OtherTok{\textless{}{-}} \FunctionTok{tail}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix[table.}\FloatTok{3.}\NormalTok{matrix[,}\DecValTok{4}\NormalTok{]}\SpecialCharTok{!=}\StringTok{""}\NormalTok{,}\DecValTok{4}\NormalTok{],}\DecValTok{2}\NormalTok{)}
\NormalTok{table.}\FloatTok{3.}\NormalTok{matrix[}\FunctionTok{c}\NormalTok{(}\FunctionTok{length}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix[,}\DecValTok{4}\NormalTok{])}\SpecialCharTok{{-}}\DecValTok{3}\NormalTok{,}\FunctionTok{length}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix[,}\DecValTok{4}\NormalTok{])}\SpecialCharTok{{-}}\DecValTok{2}\NormalTok{),}\DecValTok{4}\NormalTok{] }\OtherTok{\textless{}{-}} \StringTok{""}
\CommentTok{\#Log{-}Likelyhoods}
\NormalTok{LLH }\OtherTok{\textless{}{-}} \FunctionTok{rep}\NormalTok{(}\ConstantTok{NA}\NormalTok{, }\FunctionTok{length}\NormalTok{(distributions))}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(distributions))\{LLH[i] }\OtherTok{\textless{}{-}}\NormalTok{ GARCHfit.object[[i]]}\SpecialCharTok{@}\NormalTok{fit}\SpecialCharTok{$}\NormalTok{LLH\}}
\NormalTok{names.table}\FloatTok{.3} \OtherTok{\textless{}{-}} \FunctionTok{revalue}\NormalTok{(}\FunctionTok{names}\NormalTok{(adj.list[[}\DecValTok{3}\NormalTok{]]), }\FunctionTok{c}\NormalTok{(}\StringTok{"mu"}\OtherTok{=}\StringTok{"$}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{alpha\_0$"}\NormalTok{, }\StringTok{"ar1"}\OtherTok{=}\StringTok{"$}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{alpha\_1$"}\NormalTok{, }\StringTok{"omega"}\OtherTok{=} \StringTok{"$}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{beta\_0$"}\NormalTok{, }\StringTok{"alpha1"}\OtherTok{=}\StringTok{"$}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{beta\_1$"}\NormalTok{, }\StringTok{"beta1"}\OtherTok{=}\StringTok{"$}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{beta\_2$"}\NormalTok{, }\StringTok{"gamma1"}\OtherTok{=}\StringTok{"$}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{gamma$"}\NormalTok{, }\StringTok{"skew"}\OtherTok{=}\StringTok{"$}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{lambda$"}\NormalTok{, }\StringTok{"shape"}\OtherTok{=}\StringTok{"$}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{kappa$"}\NormalTok{, }\StringTok{"eta11"}\OtherTok{=}\StringTok{"$rot$"}\NormalTok{, }\StringTok{"eta21"}\OtherTok{=}\StringTok{"$shift$"}\NormalTok{), }\AttributeTok{warn\_missing =}\NormalTok{ F)}
\NormalTok{kappa.object }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(}\FunctionTok{matrix}\NormalTok{(}\AttributeTok{data =} \StringTok{""}\NormalTok{, }\AttributeTok{nrow =} \DecValTok{2}\NormalTok{, }\AttributeTok{ncol =} \DecValTok{3}\NormalTok{) ,table.}\FloatTok{3.}\NormalTok{matrix[(}\FunctionTok{nrow}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix)}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{)}\SpecialCharTok{:}\NormalTok{(}\FunctionTok{nrow}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix)),}\DecValTok{4}\SpecialCharTok{:}\DecValTok{5}\NormalTok{])}
\NormalTok{eta }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix[(}\FunctionTok{nrow}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix)}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{)}\SpecialCharTok{:}\NormalTok{(}\FunctionTok{nrow}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix)),}\DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{], }\FunctionTok{matrix}\NormalTok{(}\AttributeTok{data =} \StringTok{""}\NormalTok{, }\AttributeTok{nrow =} \DecValTok{2}\NormalTok{, }\AttributeTok{ncol =} \DecValTok{2}\NormalTok{) )}
\NormalTok{table.}\FloatTok{3.}\NormalTok{matrix[(}\FunctionTok{nrow}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix)}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{)}\SpecialCharTok{:}\NormalTok{(}\FunctionTok{nrow}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix)),] }\OtherTok{\textless{}{-}}\NormalTok{ kappa.object}
\NormalTok{table.}\FloatTok{3.}\NormalTok{matrix }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix, eta, }\FunctionTok{round}\NormalTok{(LLH,}\DecValTok{3}\NormalTok{))}
\NormalTok{table.}\FloatTok{3.}\NormalTok{matrix }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(}\FunctionTok{c}\NormalTok{(names.table}\FloatTok{.3}\NormalTok{,}\StringTok{"$}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{eta$"}\NormalTok{,}\StringTok{"p{-}val eta"}\NormalTok{,}\StringTok{"$LLH$"}\NormalTok{), table.}\FloatTok{3.}\NormalTok{matrix)}
\NormalTok{table.}\FloatTok{3.}\NormalTok{matrix }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix, }\AttributeTok{row.names =} \FunctionTok{c}\NormalTok{(names.table}\FloatTok{.3}\NormalTok{,}\StringTok{"$}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{eta$"}\NormalTok{,}\StringTok{""}\NormalTok{,}\StringTok{"LLH"}\NormalTok{))}
\FunctionTok{return}\NormalTok{(table.}\FloatTok{3.}\NormalTok{matrix)}
\NormalTok{\}}

\CommentTok{\#PARTIAL RESULTS}

\NormalTok{Table.}\FloatTok{3.}\NormalTok{iGARCH }\OtherTok{\textless{}{-}} \FunctionTok{Table.GARCH.function}\NormalTok{(}\AttributeTok{GARCHfit.object =}\NormalTok{ garchfit.iGARCH)}
\NormalTok{Table.}\FloatTok{3.}\NormalTok{eGARCH }\OtherTok{\textless{}{-}} \FunctionTok{Table.GARCH.function}\NormalTok{(}\AttributeTok{GARCHfit.object =}\NormalTok{ garchfit.eGARCH)}
\NormalTok{Table.}\FloatTok{3.}\NormalTok{gjrGARCH }\OtherTok{\textless{}{-}} \FunctionTok{Table.GARCH.function}\NormalTok{(}\AttributeTok{GARCHfit.object =}\NormalTok{ garchfit.gjrGARCH)}
\NormalTok{Table.}\FloatTok{3.}\NormalTok{sGARCH }\OtherTok{\textless{}{-}} \FunctionTok{Table.GARCH.function}\NormalTok{(}\AttributeTok{GARCHfit.object =}\NormalTok{ garchfit.sGARCH)}
\NormalTok{Table.}\FloatTok{3.}\NormalTok{EWMA }\OtherTok{\textless{}{-}} \FunctionTok{Table.GARCH.function}\NormalTok{(}\AttributeTok{GARCHfit.object =}\NormalTok{ garchfit.EWMA)}
\NormalTok{Table.}\FloatTok{3.}\NormalTok{fGARCH.AVGARCH }\OtherTok{\textless{}{-}} \FunctionTok{Table.GARCH.function}\NormalTok{(}\AttributeTok{GARCHfit.object =}\NormalTok{ garchfit.fGARCH.AVGARCH)}
\NormalTok{Table.}\FloatTok{3.}\NormalTok{fGARCH.NAGARCH }\OtherTok{\textless{}{-}} \FunctionTok{Table.GARCH.function}\NormalTok{(}\AttributeTok{GARCHfit.object =}\NormalTok{ garchfit.fGARCH.NAGARCH)}
\NormalTok{Table.}\FloatTok{3.}\NormalTok{fGARCH.TGARCH }\OtherTok{\textless{}{-}} \FunctionTok{Table.GARCH.function}\NormalTok{(}\AttributeTok{GARCHfit.object =}\NormalTok{ garchfit.fGARCH.TGARCH)}
...
\NormalTok{Table}\FloatTok{.3} \OtherTok{\textless{}{-}} \FunctionTok{vector}\NormalTok{(}\AttributeTok{mode =} \StringTok{"list"}\NormalTok{, }\AttributeTok{length =} \FunctionTok{length}\NormalTok{(distributions))}
\FunctionTok{names}\NormalTok{(Table}\FloatTok{.3}\NormalTok{) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"Norm"}\NormalTok{, }\StringTok{"T"}\NormalTok{, }\StringTok{"ST"}\NormalTok{, }\StringTok{"GED"}\NormalTok{, }\StringTok{"SGED"}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(distributions))\{}
\NormalTok{  Table}\FloatTok{.3}\NormalTok{[[i]] }\OtherTok{\textless{}{-}} \FunctionTok{suppressMessages}\NormalTok{(}\FunctionTok{Table.3.function}\NormalTok{(}\AttributeTok{distribution =}\NormalTok{ distributions[i]))}
\NormalTok{\}}

\CommentTok{\#Testing the kabling}
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(Table}\FloatTok{.3}\SpecialCharTok{$}\NormalTok{ST)}
\end{Highlighting}
\end{Shaded}
