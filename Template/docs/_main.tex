...
\begin{acknowledgements}
  ...
  Finally, we thank \textcite{alexios2020} for making the implementation of GARCH models integrated in R via his package ``Rugarch''. By doing this, he facilitated the process of understanding the whole process and doing the analysis for our thesis.
...
\hypertarget{avgarch-model-in-our-paper-ts-paper-to-taylor-and-schwert}{%
\subsubsection{avGARCH model (in our paper: TS-paper to Taylor and Schwert)}\label{avgarch-model-in-our-paper-ts-paper-to-taylor-and-schwert}}
