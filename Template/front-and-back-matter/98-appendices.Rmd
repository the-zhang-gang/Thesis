...
```{r, include=FALSE}
require(readr)
R <- suppressWarnings(as.matrix(read_csv("Rdata")[,-1]))
```
...
\newpage
\clearpage
\noindent Then, in figure \@ref(fig:aic4) the same patter arises as in figure \@ref(fig:aic2), the skewed student's t distribution again seems to be the most optimal one to use. Therefore the ST distribution is chosen as the most suited model for the Euro Stoxx 50 index.
