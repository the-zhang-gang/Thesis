...
[^appendices-3]: Also referred to as $n$ by @theodossiou1998 or $\eta$ by @bali2008. This is the $q$ by Carter Davis in the "sgt" package.
...
```{r aic1, fig.align='center', fig.cap='Goodness of fit symmetric GARCH and distributions'}
