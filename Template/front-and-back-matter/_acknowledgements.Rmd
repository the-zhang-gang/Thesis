...
\noindent Finally, we thank @alexios2020 for making the implementation of GARCH models integrated in R via his package "Rugarch". By doing this, he facilitated the process of understanding the whole process and doing the analysis for our thesis. \ \
